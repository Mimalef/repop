<%@ Page Language="C#" MasterPageFile="~/Masters/MasterPagePersonnel.master" AutoEventWireup="true" CodeFile="PersonnelAddCustomer.aspx.cs" Inherits="PersonnelAddCustomer" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <div class="center">
        <table class="form">
            ...
            <tr>
                <td>
                    <asp:Label ID="Label6" runat="server" Text="آدرس:"></asp:Label>
                </td>
                <td>
